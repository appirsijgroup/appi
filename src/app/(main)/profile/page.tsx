...
import Pengaturan from '@/components/features/profile/Pengaturan';
...
export default function ProfilePage() {
    ...
    React.useEffect(() => {
        ...
        const checkAndLoad = async () => {
            ...
            try {
                ...
                setAllUsersData((prev: Record<string, { employee: Employee; attendance: any; history: any }>) => {
                    const next = { ...prev };
    ...
    const handleUpdateProfile = async (userId: string, updates: Partial<Employee>) => {
        try {
            // Update to Database database using employee service
