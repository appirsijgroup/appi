...
export const UnifiedActivitySessionForm = ({
    allUsers,
    hospitals = [],
    onCreateActivity,
    onCreateSessions,
    ...
    useEffect(() => {
        if (isEditing && initialData) {
            ...
            setType(currentType as ActivitySessionType);
    ...
    const employeesInHospital = useMemo(() => {
        ...
        return allUsers.filter(u => {
            const hId = (u.hospitalId || u.hospital_id || '').toString().toLowerCase().trim();
    ...
    const handleSubmit = () => {
        ...
        // 🔒 Validate date is not in a past month
    ...
    const SegmentedControlButton = ({ label, icon: Icon, isActive, onClick }: SegmentedControlButtonProps) => (
        <button
            type="button"
            onClick={onClick}
                        ...
                        <div className="p-3 sm:p-5 bg-black/20 rounded-xl border border-white/5 sm:border-white/10">
                            ...
                            <div className="mb-4">
                                ...
                                <p className="text-xs text-gray-400 mt-1">
                                    💡 Hanya dapat memilih tanggal dari bulan ini dan seterusnya
                                </p>
                            </div>
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        <label className="text-sm font-medium text-blue-100 flex justify-between items-center">
                                            <span>Pilih RSIJ GROUP (Rumah Sakit)</span>
