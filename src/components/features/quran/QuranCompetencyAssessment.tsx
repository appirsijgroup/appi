...
export const QuranCompetencyAssessment: React.FC<QuranCompetencyAssessmentProps> = ({
    ...
    const handleSave = async () => {
        ...
        const assessmentData: Omit<EmployeeQuranCompetency, 'id' | 'assessedAt'> = {
            ...
            readingLevelId: readingLevel,
            tajwidLevelId: tajwidLevel,
            memorizationLevelId: memorizationLevel,
            understandingLevelId: understandingLevel,
            readingChecklist: readingList,
            tajwidChecklist: tajwidList,
            memorizationChecklist: memorizationList,
            understandingChecklist: understandingList,
            assessorId
        };
