...
const QuranCompetencyReport: React.FC<QuranCompetencyReportProps> = ({
    ...
    const handleExportExcel = () => {
        const exportData = filteredEmployees.map(emp => ({
            ...
            'Reading': emp.quranCompetency?.readingLevelId || 'Belum Dinilai',
            'Tajwid': emp.quranCompetency?.tajwidLevelId || 'Belum Dinilai',
            'Hafalan': emp.quranCompetency?.memorizationLevelId || 'Belum Dinilai',
            'Adab': emp.quranCompetency?.understandingLevelId || 'Belum Dinilai',
                                        ...
                                        {paginatedEmployees.map(emp => (
                                            <tr key={emp.id} className="hover:bg-white/5 transition-colors">
                                                ...
                                                <td className="px-6 py-4 text-center whitespace-nowrap">
                                                    <LevelBadge
                                                        code={emp.quranCompetency?.readingLevelId || 'R0'}
                                                ...
                                                <td className="px-6 py-4 text-center whitespace-nowrap">
                                                    <LevelBadge
                                                        code={emp.quranCompetency?.tajwidLevelId || 'T0'}
                                                ...
                                                <td className="px-6 py-4 text-center whitespace-nowrap">
                                                    <LevelBadge
                                                        code={emp.quranCompetency?.memorizationLevelId || 'H0'}
                                                ...
                                                <td className="px-6 py-4 text-center whitespace-nowrap">
                                                    <LevelBadge
                                                        code={emp.quranCompetency?.understandingLevelId || 'P0'}
